...
void Display() {
    glLineWidth(4.0);
    float StartShape[12][2] = { {-20,-20},{-13,-20},{-10,-10},{0,-10},{3,-20},{10,-20},{-5,23},{-15,-5},{-1,-5},{-5,10},{-9,-5},{-15,-5} };//huruf A
    float EndShape[12][2] = { {-20,-20},{-10,-20},{-5,-10},{0,0},{5,10},{10,20},{0,20},{-10,20},{-20,20},{-20,12},{-4,12},{-10,0} };//angka 7
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Alfendio Alif Faudisyah - 672019222");
